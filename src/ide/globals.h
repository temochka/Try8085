...
*/
#ifndef TRY8085_GLOBALS_H
#define TRY8085_GLOBALS_H
#include <QString>

class Globals
{
public:
  static QString getSettingsOrg() { return "IKIT"; }
  static QString getSettingsApp() { return "Try8085"; }
};

#endif // TRY8085_GLOBALS_H
